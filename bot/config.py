...
try:
    APP_ID = config("7414019", cast=int)
    API_HASH = config("7414019")
    BOT_TOKEN = config("6899043837:AAE-8GyW26E2kuQrolRK2QQIUQiglnMhj_s")
    DEV = 1350488685
    OWNER = config("GeekLuffy")
    ...
    THUMBNAIL = config("THUMBNAIL", default="https://telegra.ph//file/1ee9048edc98aa7e1e32c.jpg")
